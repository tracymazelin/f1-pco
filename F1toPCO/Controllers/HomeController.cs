...
namespace F1toPCO.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        /// <summary>
        /// Check to see if they have already agreed to terms.
        /// </summary>
        /// <returns></returns>
        private bool GetTerms()
        {
            ...
            sqlcom.Connection = sqlConn;
            sqlcom.CommandType = CommandType.Text;
            sqlcom.CommandText = "Select Individual FROM ChurchData WHERE ChurchCode = '" + this.F1ChurchCode + "'";
            sqlConn.Open();
            var terms = sqlcom.ExecuteScalar();
            sqlConn.Close();
            return terms as int? != null;
        }
